...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01091();
    ...
    private static final Interpolator sInterpolator = new C01102();
    ...
    private final Runnable mEndScrollRunnable = new C01113();
    ...
    static class C01091 implements Comparator<ItemInfo> {
        C01091() {
        }
    ...
    static class C01102 implements Interpolator {
        C01102() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C01121());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C01121 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01121() {
            }
