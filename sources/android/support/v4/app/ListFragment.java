...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00282();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00271();
    ...
    class C00282 implements OnItemClickListener {
        C00282() {
        }
