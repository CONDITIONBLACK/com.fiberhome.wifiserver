...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00811();
    ...
    static class C00811 implements Creator<PlaybackStateCompat> {
        C00811() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00821();
        ...
        static class C00821 implements Creator<CustomAction> {
            C00821() {
            }
